                        ...
                        <div className="ml-6 flex flex-1 flex-col">
                          ...
                          <div className="flex flex-1 items-end justify-between pt-2">
                            <p className="mt-1 text-sm font-medium text-gray-900">
                              ...
                              {new Intl.NumberFormat("vi-VN", { style: "currency", currency: "VND" }).format(product?.price)}X {product?.qty}
                  ...
                  <dl className="space-y-6 border-t border-gray-200 py-6 px-4 sm:px-6">
                    ...
                    <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                      ...
                      <dd className="text-base font-medium text-gray-900">
                        {/* $ {sumTotalPrice}.00 */}
                        {new Intl.NumberFormat("vi-VN", { style: "currency", currency: "VND" }).format(sumTotalPrice)}
                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                    {orderLoading ? (
                      ...
                      <button
                        ...
                        Confirm Payment - {new Intl.NumberFormat("vi-VN", { style: "currency", currency: "VND" }).format(sumTotalPrice)}
                        {/* ${sumTotalPrice} */}
