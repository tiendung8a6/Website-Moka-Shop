...
import ButtonOrder from "../Categories/ButtonOrder/buttonOrder";
    ...
    <>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
            <a href="/admin/manage-coupon" className="font-medium text-indigo-600 hover:text-indigo-500">
              Manage Coupons
            </a>
          </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={onHandleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">
                {/* discount */}
                Discount (in %)<span className="text-red-500 font-bold"> *</span>
              </label>
              <div className="mt-1">
                <input
                  name="discount"
