      ...
      <div className="min-h-full">
        ...
        <div className="hidden z-50 lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex flex-grow flex-col overflow-y-auto  bg-cyan-900  pb-4">
            ...
            <nav
              className="mt-5 flex flex-1 flex-col overflow-y-auto divide-y divide-cyan-800 "
              aria-label="Sidebar"
            >
                ...
                <div className="space-y-1 px-2">
                  ...
                  {ordersLinks.map((item) => (
                    <NavLink
                      key={item.name}
                      to={item.href}
                      className={`${activeTab === item.name ? "active-style" : "notactive"
                        }`}
                      onClick={() => handleTabClick(item.name)}
                    >
                      <item.icon
                        className="mr-4 h-6 w-7 text-cyan-200"
                        aria-hidden="true"
                      />
                      {item.name}
                    </NavLink>
                ...
                <div className="space-y-1 px-2">
                  ...
                  {productsLinks.map((item) => (
                    <NavLink
                      key={item.name}
                      to={item.href}
                      className={({ isActive }) => (isActive ? "active-style" : 'notactive')}
              ...
              {/* OptionLinks desktop */}
              <div className="mt-1 pt-1">
                <div className="space-y-1 px-2 ml-[4px]">
