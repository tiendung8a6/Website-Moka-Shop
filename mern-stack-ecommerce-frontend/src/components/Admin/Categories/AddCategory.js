...
export default function CategoryToAdd() {
  ...
  const [activeLink, setActiveLink] = useState("/admin/add-brand");
  return (
    <>
                ...
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  <div className="flex max-w-lg justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                    <div className="space-y-1 text-center">
                      {imageURL ? (
                        <img src={imageURL} className="flex justify-center w-[80px] h-[fix-content]" alt="Uploaded Image" />
                      ) : (
                        <svg
                ...
                <div>
                  <div>
                    <Link
                      ...
                      className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-green-500 py-2 px-4 text-sm font-medium text-white  hover:bg-cyan-500 hover:shadow-lg hover:shadow-blue-500/50"
                    >
                      Add Category
                    </Link>
                  </div>
