              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                ...
                <div>
                  <div>
                    <Link
                      to="/admin/add-color"
                      className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-blue-500 py-2 px-4 text-sm font-medium text-white  hover:bg-cyan-500 hover:shadow-lg hover:shadow-blue-500/50">
                      Add Color
                    </Link>
                  </div>
                </div>
